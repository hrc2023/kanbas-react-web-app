    ...
    <div id="wd-people-table">
      <table className="table table-striped">
        ...
        <tbody>
            ...
            <td className="wd-total-activity">11:27:12</td> </tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-16</td>
            <td className="wd-total-activity">17:05:19</td> </tr>
            ...
            <td className="wd-total-activity">23:46:02</td> </tr>
        </tbody>
      </table>
    </div> );}