...
const BootstrapForms = () => {
    ...
    <><div id="wd-css-styling-forms">
            ...
            <div className="mb-3">
            ...
            </div><div id="wd-css-styling-switches">
                <h3>Switches</h3>
            ...
            </div><div id="wd-css-styling-range-and-sliders">
                <h3>Range</h3>
            ...
            </div><div id="wd-css-styling-addons">
                <h3>Addons</h3>
                ...
                <div className="input-group">
                    ...
                    <span className="input-group-text">$</span>
                    <span className="input-group-text">0.00</span>
                </div></div><div id="wd-css-responsive-forms-1">
            ...
            </div><div id="wd-css-responsive-forms-2">
